...
public class TownReset : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            Debug.LogWarning("No button assigned to TownReset script on " + gameObject.name);
        }
        ...
        {
            Debug.LogWarning("PlayerMovement not found by TownReset.");
        }
    }
    ...
    public void OnButtonClick()
    {
        ...
        // If you want to use inspector value, use targetSceneName.
    ...
    private void ResetPlayerStat()
    {
        ...
        if (playerMovement != null)
        {
            ...
            Debug.Log("Player stats reset via TownReset.");
        }
        else
        {
    ...
    private void EnableAndResetAllGunScripts()
    {
        ...
        Debug.Log("All gun scripts enabled and ResetSpeed() called.");
    }
